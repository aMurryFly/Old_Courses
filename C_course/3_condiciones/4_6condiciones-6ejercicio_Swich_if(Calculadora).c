...
divi=0; 
	...
	if (input<=5)
		switch ( input )  
		{
			...
			printf("\nNOTAS:"); 		 		
			printf("\nLa pr%cxima versi%cn tratar%c de emplear un ciclo WHILE para", 162, 162, 130); 
	...
	{
		if (input>0)
		printf("\nVuelva a escribir alguna de las opciones del menu:  ");
		scanf("%d", &input); // No olvides poner la lectura del dato o si no se irá a default
			switch ( input )  
	{
		case 1:
		...
		printf("\nUppss te equivocaste otra vez de  opci%cn",162 );
		printf("\nNOTAS:"); 		 		
		printf("\nLa pr%cxima versi%cn tratar%c de emplear un ciclo WHILE o algo parecido para", 162, 162, 130); 
		printf("\npoder hacer infinita esta calculadora ya que esta solamente permite una veces el error"); 
